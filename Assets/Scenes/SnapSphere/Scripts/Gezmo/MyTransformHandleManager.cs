...
{
  public class MyTransformHandleManager : Singleton<MyTransformHandleManager>
  {
    ...
    {
      SceneManager.activeSceneChanged += new UnityAction<UnityEngine.SceneManagement.Scene, UnityEngine.SceneManagement.Scene>(OnActiveSceneChanged);
      InitializeManager();
    }
    ...
    protected virtual void OnActiveSceneChanged(UnityEngine.SceneManagement.Scene oldScene, UnityEngine.SceneManagement.Scene newScene)
    {
    ...
    protected virtual void Update()
    {
      ...
      if (Input.touchCount > 0)
      {
        ...
        GetHandleFromTouch(ref _hoveredHandle, ref _handleHitPoint, touch.position);
    ...
    protected virtual void GetHandleFromTouch(ref HandleBase handle, ref Vector3 hitPoint, Vector2 touchPosition)
    {
    ...
    protected virtual void TouchInput(Touch touch)
    {
      switch (touch.phase)
      {
        ...
        case TouchPhase.Moved:
          ...
          {
            _draggingHandle.Interact(touch.position);
            OnInteraction();
          }
          break;
      ...
      _previousMousePosition = touch.position;
    }
